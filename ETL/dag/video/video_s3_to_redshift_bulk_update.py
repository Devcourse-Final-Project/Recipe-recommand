...
dag = DAG(
    dag_id="video_s3_to_redshift_bulk_update",
...
drop_table = PostgresOperator(
    ...
    sql="DROP TABLE IF EXISTS raw_data.video_recipe;",
    dag=dag,
)
...
create_table = PostgresOperator(
    ...
    postgres_conn_id="redshift_dev_db",  # The connection id in Airflow Connections.
    sql="""
        CREATE TABLE raw_data.video_recipe (
...
bulk_update = S3ToRedshiftOperator(
    ...
    s3_key="test/recipe/merge_recipe/video_merge_data_23-09-02_16:28:00.csv",
